...
//import/export
Route::match(['get', 'post'], '/importTemplate',
    'TemplateController@importTemplate')->name('template.admin.importTemplate');
Route::match(['get'], '/exportTemplate/{id}',
    'TemplateController@exportTemplate')->name('template.admin.exportTemplate');
