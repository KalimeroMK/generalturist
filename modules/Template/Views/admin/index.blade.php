    ...
    <div class="container">
        <div class="d-flex justify-content-between mb20">
            ...
            <div class="title-actions">
                <a href="{{route('template.admin.importTemplate')}}"
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                @if(!empty($rows))
                    <form method="post" action="{{route('template.admin.bulkEdit')}}"
            ...
            <div class="col-left">
                <form method="get" action="{{route('template.admin.index')}} "
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                       href="{{route('template.admin.edit',[$row->id])}}"> <i
                                                                class="fa fa-edit"
                                                                aria-hidden="true"></i> {{__('Edit')}}</a>
                                                    <a class="dropdown-item"
                                                       href="{{route('template.admin.exportTemplate',[$row->id])}}"> <i
                                                                class="fa fa-download"
                                                                aria-hidden="true"></i> {{__('Export')}}</a>
                                                    <a class="dropdown-item"
                                                       href="{{URL::signedRoute('template.admin.clone',[$row->id])}}">
                                                        <i class="fa fa-copy" aria-hidden="true"></i> {{__('Clone')}}
                                                    </a>
                                                </div>
                                            </div>
