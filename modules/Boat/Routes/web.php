...
Route::group(['prefix' => 'user/'.config('boat.boat_route_prefix'), 'middleware' => ['auth', 'verified']], function () {
    ...
    Route::get('/booking-report/bulkEdit/{id}',
        'ManageBoatController@bookingReportBulkEdit')->name("boat.vendor.booking_report.bulk_edit");
...
Route::group(['prefix' => 'user/'.config('boat.boat_route_prefix')], function () {
    Route::group(['prefix' => 'availability'], function () {
        ...
        Route::get('/availabilityBooking',
            'AvailabilityController@availabilityBooking')->name('boat.vendor.availability.availabilityBooking');
    });
});
