...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="{!! clean($translation->title) !!}" placeholder="{{__("Name of the boat")}}"
...
<div class="panel">
    ...
    <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{$row->max_guest}}" placeholder="{{__("Example: 3")}}"
                               name="max_guest" class="form-control">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>{{__("Cabin")}}</label>
                        <input type="text" value="{{$row->cabin}}" placeholder="{{__("Example: 5")}}" name="cabin"
                               class="form-control">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{$row->length}}" placeholder="{{__("Example: 30m")}}" name="length"
                               class="form-control">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{$row->speed}}" placeholder="{{__("Example: 25km/h")}}"
                               name="speed" class="form-control">
                    </div>
                </div>
            </div>
        @endif
        <div class="form-group-item">
                ...
                @if(!empty($translation->specs))
                    ...
                    @foreach($translation->specs as $key=>$spec)
                        <div class="item" data-number="{{$key}}">
                            <div class="row">
                                <div class="col-md-5">
                                    <input type="text" name="specs[{{$key}}][title]" class="form-control"
                                           value="{{$spec['title']}}" placeholder="{{__('Eg: Range')}}">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="specs[{{$key}}][content]" class="form-control"
                                           value="{{$spec['content']}}" placeholder="{{__('Eg: 6000km')}}">
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-danger btn-sm btn-remove-item"><i
                                                class="fa fa-trash"></i></span>
            ...
            <div class="g-more hide">
                <div class="item" data-number="__number__">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" __name__="specs[__number__][title]" class="form-control"
                                   placeholder="{{__('Eg: Range')}}">
                        </div>
                        <div class="col-md-6">
                            <input type="text" __name__="specs[__number__][content]" class="form-control" value=""
                                   placeholder="{{__('Eg: 6000km')}}">
                        </div>
                        <div class="col-md-1">
                            <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="cancel_policy" class="form-control" rows="5"
                      placeholder="{{ __("Full refund up to 4 days prior.") }}">{{$translation->cancel_policy}}</textarea>
        </div>
        <div class="form-group">
            <label>{{__("Additional Terms & Information")}}</label>
            <textarea name="terms_information" class="d-none has-ckeditor" rows="10"
                      placeholder="{{ __("For Sanitary purposes ONLY, although there is a working toilet and shower, we've deactivated the shower and the toliet is for limited use (urine only..pardon the graphic detail!)...") }}">{{$translation->terms_information}}</textarea>
        </div>
