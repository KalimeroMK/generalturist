                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="price_per_hour" class="form-control"
                                   value="{{$row->price_per_hour}}" placeholder="{{__("Price per hour")}}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="control-label">{{__("Price per day")}}</label>
                            <input type="number" step="any" name="price_per_day" class="form-control"
                                   value="{{$row->price_per_day}}" placeholder="{{__("Price per day")}}">
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="start_time_booking" class="form-control">
                                    ...
                                    @for ( $i = $startTime ; $i <= $endTime ; $i = $i + 1800)
                                        <option @if($row->start_time_booking == date( 'H:i', $i )) selected
                                                @endif value="{{ date( 'H:i', $i ) }}">{{ date( 'H:i', $i ) }}</option>
                                    @endfor
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="end_time_booking" class="form-control">
                                    <option value="">{{ __("-- Select --") }}</option>
                                    @for ( $i = $startTime ; $i <= $endTime ; $i = $i + 1800)
                                        <option @if($row->end_time_booking == date( 'H:i', $i )) selected
                                                @endif value="{{ date( 'H:i', $i ) }}">{{ date( 'H:i', $i ) }}</option>
                                    @endfor
                                </select>
                            </div>
