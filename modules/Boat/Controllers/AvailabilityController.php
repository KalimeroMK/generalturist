...
class AvailabilityController extends FrontendController
{
    ...
    public function loadDates(Request $request)
    {
        ...
        $bookings = $this->bookingClass::getAllBookingInRanges($boat->id, $boat->type, $request->query('start'),
            $request->query('end'));
        //dd($bookings);
    ...
    public function store(Request $request)
    {
        ...
        foreach ($period as $dt) {
            $date = $this->boatDateClass::where('start_date', $dt->format('Y-m-d'))->where('target_id',
                $target_id)->first();
            ...
            $date->fillByAttr(['start_date', 'end_date', 'price_per_hour', 'price_per_day', 'number', 'active',],
                $postData);
