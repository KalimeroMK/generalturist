...
@php use Modules\User\Listeners\SendMailUserRegisteredListen; @endphp
@php use Modules\User\Emails\EmailUserVerifyRegister; @endphp
@php use Modules\User\Emails\ResetPasswordToken; @endphp
@if(is_default_lang())
    <div class="row">
        <div class="col-sm-4">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="user_disable_register" value="1"
                                          @if(setting_item('user_disable_register')) checked @endif> {{__("Yes, please disable it")}}
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="col-sm-8">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox" name="user_enable_2fa" value="1"
                                          @if(setting_item('user_enable_2fa')) checked @endif > {{__('Yes, please enable it')}}
                            </label>
                        </div>
...
<div class="row">
    <div class="col-sm-4">
        ...
        <div class="form-group-desc">{{ __('Content email send to Customer or Administrator when user registered.')}}
            @foreach(SendMailUserRegisteredListen::CODE as $item=>$value)
...
<div class="row">
    <div class="col-sm-4">
        ...
        <div class="form-group-desc">{{ __('Content email verify send to Customer when user registered.')}}
            @foreach(EmailUserVerifyRegister::CODE as $item=>$value)
                <div><code>{{$value}}</code></div>
            @endforeach
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-4">
        ...
        <div class="form-group-desc">
            @foreach(ResetPasswordToken::CODE as $item=>$value)
                <div><code>{{$value}}</code></div>
            @endforeach
        </div>
    </div>
