                                    ...
                                    @foreach($wallet_deposit_lists as $k=>$item)
                                        <tr>
                                            ...
                                            <td><label class="btn btn-info">
                                                    <input type="radio" name="deposit_option"
                                                           value="{{$k}}"> {{__("Select")}} </label></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                    ...
                    @else
                        <div class="form-section mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control update_exchange_value" name="deposit_amount"
                                       placeholder="{{__('Deposit amount')}}" aria-describedby="basic-addon2">
                        ...
                        <div class="gateways-table accordion mt-3" id="accordionExample">
                            @foreach($gateways as $k=>$gateway)
                                <div class="card">
                                    ...
                                    <div id="gateway_{{$k}}" class="collapse" aria-labelledby="headingOne"
