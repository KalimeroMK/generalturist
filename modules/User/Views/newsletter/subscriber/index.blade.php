        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{route('user.admin.subscriber.bulkEdit')}}"
                    ...
                    <div class="col-left">
                        <form method="get" action="{{route('user.admin.subscriber.index')}} "
                              class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            <a class="btn btn-warning btn-icon" href="{{route('user.admin.subscriber.export')}}"
                               target="_blank" title="{{__("Export to excel")}}"><i
                                        class="icon ion-md-cloud-download"></i>&nbsp;{{__
                            ('Export')}}
                            </a>
