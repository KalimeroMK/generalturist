...
class UserController extends FrontendController
{
    ...
    public function dashboard(Request $request)
    {
        ...
        $data = [
            ...
            'earning_chart_data' => Booking::getEarningChartDataForVendor(strtotime('monday this week'), time(),
                $user_id),
    ...
    public function upgradeVendor(Request $request)
    {
        ...
        if (!empty($vendorRequest)) {
            return redirect()->back()->with('warning',
                __("You have just done the become vendor request, please wait for the Admin's approved"));
        }
