...
class ProfileController extends FrontendController
{
    ...
    public function alLReviews(Request $request, $id_or_slug)
    {
        ...
        $data['breadcrumbs'] = [
            [
                ...
                'url' => route('user.profile', ['id' => $user->user_name ?? $user->id])
            ],
    ...
    public function allServices(Request $request, $id_or_slug)
    {
        ...
        $data['user'] = $user;
        $data['page_title'] = __(':name - :type',
            ['name' => $user->getDisplayName(), 'type' => $moduleClass::getModelName()]);
        $data['breadcrumbs'] = [
            [
                'name' => $user->getDisplayName(),
                'url' => route('user.profile', ['id' => $user->user_name ?? $user->id])
            ...
            [
                'name' => __(':type by :first_name',
                    ['type' => $moduleClass::getModelName(), 'first_name' => $user->first_name]), 'url' => ''
            ],
        ];
        $data['type'] = $type;
