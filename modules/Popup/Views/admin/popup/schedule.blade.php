        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="schedule_amount" min="1"
                           value="{{old('schedule_amount',$row->schedule_amount)}}" class="form-control">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" name="schedule_type">
                        ...
                        <option value="month"
                                @if($row->schedule_type == 'month') selected @endif >{{__("Month")}}</option>
