...
Route::group(['prefix' => 'attribute'], function () {
    ...
    Route::get('getAttributeForSelect2',
        'AttributeController@getAttributeForSelect2')->name('hotel.admin.attribute.getForSelect2');
});
Route::group(['prefix' => 'room'], function () {
    Route::group(['prefix' => 'attribute'], function () {
        ...
        Route::post('editAttrBulk',
            'RoomAttributeController@editAttrBulk')->name('hotel.admin.room.attribute.editAttrBulk');
        ...
        Route::get('getForSelect2',
            'RoomAttributeController@getForSelect2')->name('hotel.admin.room.attribute.term.getForSelect2');
    });
