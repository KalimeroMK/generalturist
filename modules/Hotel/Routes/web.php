...
Route::group(['prefix' => 'user/'.config('hotel.hotel_route_prefix'), 'middleware' => ['auth', 'verified']],
    function () {
        ...
        Route::get('/booking-report/bulkEdit/{id}',
            'VendorController@bookingReportBulkEdit')->name("hotel.vendor.booking_report.bulk_edit");
        ...
        Route::group(['prefix' => 'room'], function () {
            ...
            Route::get('{hotel_id}/bulkEdit/{id}',
                'VendorRoomController@bulkEdit')->name('hotel.vendor.room.bulk_edit');
        });
    });
...
Route::post(config('hotel.hotel_route_prefix').'/checkAvailability',
    'HotelController@checkAvailability')->name('hotel.checkAvailability');
