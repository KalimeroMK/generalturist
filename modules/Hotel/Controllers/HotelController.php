...
class HotelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($list)) {
            foreach ($list as $row) {
                $markers[] = [
                    ...
                    'marker' => get_file_url(setting_item("hotel_icon_marker_map"),
        ...
        $data['attributes'] = Attributes::where('service', 'hotel')->orderBy("position", "desc")->with([
            'terms', 'translation'
        ])->get();
        $data['layout'] = $layout;
    ...
    public function detail(Request $request, $slug)
    {
        ...
        if (!empty($location_id)) {
            $hotel_related = $this->hotelClass::where('location_id', $location_id)->where("status",
