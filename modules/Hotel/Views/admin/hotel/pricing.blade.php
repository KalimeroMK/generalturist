    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="form-group d-none">
                ...
                <br>
                <label>
                    <input type="checkbox" name="allow_full_day" @if($row->allow_full_day) checked
                           @endif value="1"> {{__("Enable full day booking")}}
                </label>
                <div class="small">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$row->check_in_time}}" placeholder="{{__("Eg: 12:00AM")}}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$row->check_out_time}}" placeholder="{{__("Eg: 11:00AM")}}"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="price" class="form-control"
                                   value="{{$row->price}}" placeholder="{{__("Hotel Price")}}">
                        </div>
                    </div>
                    <div class="col-lg-6 d-none">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" name="sale_price" class="form-control"
                                   value="{{$row->sale_price}}" placeholder="{{__("Hotel Sale Price")}}">
