                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                ...
                                                @endforeach
                                            @else
                                                <input type="text" name="hotel_search_fields[{{$key}}][title]"
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="hotel_search_fields[{{$key}}][position]" min="0"
                            ...
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    <div class="col-md-7">
                                        @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                            @foreach($languages as $language)
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang">{{$language->name}}</div>
                                                    <input type="text"
                                                           __name__="hotel_search_fields[__number__][title{{$key_lang}}]"
                                                           class="form-control">
                                                </div>
                                            @endforeach
                                        @else
                                        ...
                                        <br>
                                        <select __name__="hotel_search_fields[__number__][attr]"
                                                class="mt-2 custom-select">
                                            <option value="">{{__("-- Select Attribute --")}}</option>
                                            @foreach($attrs as $attr)
