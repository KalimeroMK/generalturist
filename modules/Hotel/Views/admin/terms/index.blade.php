        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{url('admin/module/hotel/attribute/editTermBulk')}}"
                    ...
                    <div class="col-left">
                        <form method="get" action="{{url('/admin/module/hotel/attribute/terms/'.$attr->id)}} "
                                    ...
                                    @foreach ($rows as $row)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary btn-sm"
                                                   href="{{route('hotel.admin.attribute.term.edit',['id'=>$row->id])}}"><i
