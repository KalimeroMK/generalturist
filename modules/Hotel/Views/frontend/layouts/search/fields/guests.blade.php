        ...
        <div class="dropdown-menu select-guests-dropdown">
            <div class="dropdown-item-row">
                ...
                <div class="val">
                    ...
                    <span class="count-display"><input type="number" name="room" value="{{request()->query('room',1)}}"
                                                       min="1"></span>
            ...
            <div class="dropdown-item-row">
                ...
                <div class="val">
                    ...
                    <span class="count-display"><input type="number" name="adults"
                                                       value="{{request()->query('adults',1)}}" min="1"></span>
            ...
            <div class="dropdown-item-row">
                ...
                <div class="val">
                    ...
                    <span class="count-display"><input type="number" name="children"
                                                       value="{{request()->query('children',0)}}" min="0"></span>
