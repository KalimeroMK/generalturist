    ...
    <div class="panel">
        ...
        <div class="panel-body">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="price" class="form-control"
                                   value="{{$row->price}}" placeholder="{{__("Event Price")}}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" name="sale_price" class="form-control"
                                   value="{{$row->sale_price}}" placeholder="{{__("Event Sale Price")}}">
                        ...
                        @if(!empty($row->ticket_types))
                            @foreach($row->ticket_types as $key=>$item)
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <input type="text" @if(!is_default_lang()) disabled
                                                   @endif name="ticket_types[{{$key}}][code]" class="form-control"
                                                   value="{{$item['code']}}" placeholder="{{ __("ticket_vip_1") }}">
                                        </div>
                                        <div class="col-md-5">
                                            @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                @foreach($languages as $language)
                                                    ...
                                                    <div class="g-lang">
                                                        ...
                                                        <input type="text"
                                                               name="ticket_types[{{$key}}][name{{$key_lang}}]"
                                                               class="form-control"
                                                ...
                                                @endforeach
                                            @else
                                                <input type="text" name="ticket_types[{{$key}}][name]"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" @if(!is_default_lang()) disabled @endif min="0"
                                                   name="ticket_types[{{$key}}][price]" class="form-control"
                                                   value="{{$item['price']}}" placeholder="{{ __("Price Ticket") }}"
                                                   step="any">
                                            <lable>{{__("Number")}}</lable>
                                            <input type="number" @if(!is_default_lang()) disabled @endif min="0"
                                                   name="ticket_types[{{$key}}][number]" class="form-control"
                                                   value="{{$item['number']}}" placeholder="{{ __("Number Ticket") }}">
                                        </div>
                                        <div class="col-md-1">
                                            @if(is_default_lang())
                    ...
                    <div class="g-more hide">
                        <div class="item" data-number="__number__">
                            <div class="row">
                                <div class="col-md-2">
                                    <input type="text" @if(!is_default_lang()) disabled
                                           @endif __name__="ticket_types[__number__][code]" class="form-control"
                                ...
                                <div class="col-md-5">
                                    @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                        @foreach($languages as $language)
                                            ...
                                            <div class="g-lang">
                                                <div class="title-lang">{{$language->name}}</div>
                                                <input type="text" __name__="ticket_types[__number__][name{{$key}}]"
                                                       class="form-control" value="" placeholder="{{__('Name')}}">
                                            </div>
                                        @endforeach
                                    @else
                                        <input type="text" __name__="ticket_types[__number__][name]"
                                               class="form-control" value="" placeholder="{{__('Name')}}">
                                    @endif
                                </div>
                                <div class="col-md-4">
                                    <input type="number" min="0" __name__="ticket_types[__number__][price]"
                                           class="form-control" value="" placeholder="{{ __("Price Ticket") }}">
                                    <input type="number" min="0" __name__="ticket_types[__number__][number]"
                                           class="form-control" value="" placeholder="{{ __("Number Ticket") }}">
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-danger btn-sm btn-remove-item"><i
                                                class="fa fa-trash"></i></span>
            ...
            <div class="form-group @if(!is_default_lang()) d-none @endif">
                <label><input type="checkbox" name="enable_extra_price" @if(!empty($row->enable_extra_price)) checked
            ...
            @if(is_default_lang() and (!empty(setting_item("event_allow_vendor_can_add_service_fee")) or is_admin()))
                ...
                <div class="form-group app_get_locale">
                    <label><input type="checkbox" name="enable_service_fee"
                                  @if(!empty($row->enable_service_fee)) checked
                                ...
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <label>
                                                <input type="checkbox" min="0" name="service_fee[{{$key}}][per_ticket]"
                                                       value="on" @if($item['per_ticket'] ?? '') checked @endif >
                                                {{__("Price per ticket")}}
                                            </label>
                                        </div>
                                        <div class="col-md-1">
                        ...
                        <div class="item" data-number="__number__">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <label>
                                        <input type="checkbox" min="0" __name__="service_fee[__number__][per_ticket]"
                                               value="on">
                                        {{__("Price per ticket")}}
                                    </label>
                                </div>
