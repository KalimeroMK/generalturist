...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="{!! clean($translation->title) !!}" placeholder="{{__("Name of the event")}}"
                ...
                <div class="col-lg-6">
                    <div class="form-group @if( $row->getBookingType()== "ticket") d-none @endif">
                        ...
                        <select name="duration_unit" class="form-control">
                            <option value="hour"
                                    @if($row->duration_unit == "hour") selected @endif > {{__("Hour")}}</option>
                            <option value="minute"
                                    @if($row->duration_unit == "minute") selected @endif > {{__("Minute")}}</option>
                        </select>
                    </div>
                </div>
            </div>
