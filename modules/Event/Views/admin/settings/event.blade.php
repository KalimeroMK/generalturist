            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <input type="text" name="event_page_search_title"
                               value="{{setting_item_with_lang('event_page_search_title',request()->query('lang'))}}"
                               class="form-control">
                    </div>
                </div>
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls form-group-image">
                            {!! FileHelper::fieldUpload('event_page_search_banner',$settings['event_page_search_banner'] ?? "") !!}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-controls">
                                    <input type="number" min="1" name="event_page_limit_item"
                                           placeholder="{{ __("Default: 9") }}"
                                           value="{{setting_item_with_lang('event_page_limit_item',request()->query('lang'), 9)}}"
                                           class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3" data-condition="event_location_search_style:is(autocompletePlace)">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="event_location_radius_value" min="0"
                                       value="{{ setting_item('event_location_radius_value',1)}}" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-controls">
                                <input type="text" name="event_map_lat_default"
                                       value="{{$settings['event_map_lat_default'] ?? ''}}" class="form-control"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-controls">
                                <input type="text" name="event_map_lng_default"
                                       value="{{$settings['event_map_lng_default'] ?? ''}}" class="form-control"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-controls">
                                <input type="text" name="event_map_zoom_default"
                                       value="{{$settings['event_map_zoom_default'] ?? ''}}" class="form-control"
                                       placeholder="13">
                            </div>
                        </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <div class="form-controls form-group-image">
                            {!! FileHelper::fieldUpload('event_icon_marker_map',$settings['event_icon_marker_map'] ?? "") !!}
                        </div>
                    </div>
                @endif
            </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="seo_1">
                            <div class="form-group">
                                ...
                                <input type="text" name="event_page_list_seo_title" class="form-control"
                                       placeholder="{{__("Enter title...")}}"
                                       value="{{ setting_item_with_lang('event_page_list_seo_title',request()->query('lang'))}}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Seo Description")}}</label>
                                <input type="text" name="event_page_list_seo_desc" class="form-control"
                                       placeholder="{{__("Enter description...")}}"
                                       value="{{setting_item_with_lang('event_page_list_seo_desc',request()->query('lang'))}}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                                    <label class="control-label">{{__("Featured Image")}}</label>
                                    {!! FileHelper::fieldUpload('event_page_list_seo_image', $settings['event_page_list_seo_image'] ?? "" ) !!}
                                </div>
                            @endif
                        </div>
                        @php
                        ...
                        <div class="tab-pane" id="seo_2">
                            <div class="form-group">
                                ...
                                <input type="text" name="event_page_list_seo_share[facebook][title]"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="event_page_list_seo_share[facebook][desc]" class="form-control"
                                       placeholder="{{__("Enter description...")}}"
                            ...
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                                    ...
                                    {!! FileHelper::fieldUpload('event_page_list_seo_share[facebook][image]',$seo_share['facebook']['image'] ?? "" ) !!}
                                </div>
                            @endif
                        </div>
                        <div class="tab-pane" id="seo_3">
                            <div class="form-group">
                                ...
                                <input type="text" name="event_page_list_seo_share[twitter][title]" class="form-control"
                                       placeholder="{{__("Enter title...")}}"
                                       value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Twitter Description")}}</label>
                                <input type="text" name="event_page_list_seo_share[twitter][desc]" class="form-control"
                                       placeholder="{{__("Enter description...")}}"
                                       value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                                    ...
                                    {!! FileHelper::fieldUpload('event_page_list_seo_share[twitter][image]', $seo_share['twitter']['image'] ?? "" ) !!}
                                </div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="event_enable_review" value="1"
                                          @if(!empty($settings['event_enable_review'])) checked @endif /> {{__("Yes, please enable it")}}
                            </label>
                            <br>
                    ...
                    <div class="form-group" data-condition="event_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="event_enable_review_after_booking" value="1"
                                          @if(!empty($settings['event_enable_review_after_booking'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                    ...
                    <div class="form-group"
                         data-condition="event_enable_review:is(1),event_enable_review_after_booking:is(1)">
                                ...
                                @foreach($status as $item)
                                    <div class="col-md-4">
                                        <label><input type="checkbox"
                                                      name="event_allow_review_after_making_completed_booking[]"
                    ...
                    <div class="form-group" data-condition="event_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="event_review_approved" value="1"
                                          @if(!empty($settings['event_review_approved'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                    ...
                    <div class="form-group" data-condition="event_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <input type="number" class="form-control" name="event_review_number_per_page"
                                   value="{{ $settings['event_review_number_per_page'] ?? 5 }}"/>
                            ...
                            <div class="form-group-item">
                                ...
                                <div class="g-items">
                                    ...
                                    @foreach($social_share as $key=>$item)
                                        <div class="item" data-number="{{$key}}">
                                            <div class="row">
                                                <div class="col-md-11">
                                                    <input type="text" name="event_review_stats[{{$key}}][title]"
                                ...
                                <div class="g-more hide">
                                    <div class="item" data-number="__number__">
                                        <div class="row">
                                            <div class="col-md-11">
                                                <input type="text" __name__="event_review_stats[__number__][title]"
                    ...
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            ...
                            @if(!empty($settings['event_booking_buyer_fees']))
                                    <?php
                                    $event_booking_buyer_fees = json_decode($settings['event_booking_buyer_fees'],
                                        true); ?>
                                        ...
                                        <div class="row">
                                                ...
                                                @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                    @foreach($languages as $language)
                                                        ...
                                                        <div class="g-lang">
                                                            ...
                                                            <input type="text"
                                                                   name="event_booking_buyer_fees[{{$key}}][name{{$key_lang}}]"
                                                                   class="form-control"
                                                                   value="{{$buyer_fee['name'.$key_lang] ?? ''}}"
                                                                   placeholder="{{__('Fee name')}}">
                                                            <input type="text"
                                                                   name="event_booking_buyer_fees[{{$key}}][desc{{$key_lang}}]"
                                                                   class="form-control"
                                                    ...
                                                    @endforeach
                                                @else
                                                    <input type="text" name="event_booking_buyer_fees[{{$key}}][name]"
                                                           class="form-control" value="{{$buyer_fee['name'] ?? ''}}"
                                                           placeholder="{{__('Fee name')}}">
                                                    <input type="text" name="event_booking_buyer_fees[{{$key}}][desc]"
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" min="0" step="0.1"
                                                       name="event_booking_buyer_fees[{{$key}}][price]"
                                                       class="form-control" value="{{$buyer_fee['price']}}">
                                                <select name="event_booking_buyer_fees[{{$key}}][unit]"
                                                        class="form-control">
                                            ...
                                            <div class="col-md-3">
                                                <select name="event_booking_buyer_fees[{{$key}}][type]"
                                                ...
                                                <label>
                                                    <input type="checkbox" min="0"
                                                           name="event_booking_buyer_fees[{{$key}}][per_ticket]"
                                                           value="on"
                                                           @if($buyer_fee['per_ticket'] ?? '') checked @endif >
                                                    {{__("Price per ticket")}}
                                                </label>
                                            </div>
                                            <div class="col-md-1">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                            @foreach($languages as $language)
                                                    <?php
                                                    $key = setting_item('site_locale') != $language->locale ? "_".$language->locale : "" ?>
                                                <div class="g-lang">
                                                    <div class="title-lang">{{$language->name}}</div>
                                                    <input type="text"
                                                           __name__="event_booking_buyer_fees[__number__][name{{$key}}]"
                                                           class="form-control" value=""
                                                           placeholder="{{__('Fee name')}}">
                                                    <input type="text"
                                                           __name__="event_booking_buyer_fees[__number__][desc{{$key}}]"
                                                           class="form-control" value=""
                                                           placeholder="{{__('Fee desc')}}">
                                                </div>
                                            ...
                                            @endforeach
                                        @else
                                            <input type="text" __name__="event_booking_buyer_fees[__number__][name]"
                                                   class="form-control" value="" placeholder="{{__('Fee name')}}">
                                            <input type="text" __name__="event_booking_buyer_fees[__number__][desc]"
                                                   class="form-control" value="" placeholder="{{__('Fee desc')}}">
                                        @endif
                                    </div>
                                    <div class="col-md-3">
                                        <input type="number" min="0" step="0.1"
                                               __name__="event_booking_buyer_fees[__number__][price]"
                                               class="form-control" value="">
                                        <select __name__="event_booking_buyer_fees[__number__][unit]"
                                                class="form-control">
                                    ...
                                    <div class="col-md-3">
                                        <select __name__="event_booking_buyer_fees[__number__][type]"
                                                class="form-control d-none">
                                            <option value="one_time">{{__("One-time")}}</option>
                                        </select>
                                        <label>
                                            <input type="checkbox" min="0"
                                                   __name__="event_booking_buyer_fees[__number__][per_ticket]"
                                                   value="on">
                                            {{__("Price per ticket")}}
                                        </label>
                                    </div>
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="event_vendor_create_service_must_approved_by_admin"
                                          value="1"
                                          @if(!empty($settings['event_vendor_create_service_must_approved_by_admin'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="event_allow_vendor_can_change_their_booking_status"
                                          value="1"
                                          @if(!empty($settings['event_allow_vendor_can_change_their_booking_status'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="event_allow_vendor_can_change_paid_amount" value="1"
                                          @if(!empty($settings['event_allow_vendor_can_change_paid_amount'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="event_allow_vendor_can_add_service_fee" value="1"
                                          @if(!empty($settings['event_allow_vendor_can_add_service_fee'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
        ...
        <div class="col-sm-8">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox" name="event_deposit_enable" value="1"
                                          @if(setting_item('event_deposit_enable')) checked @endif > {{__('Yes, please enable it')}}
                            </label>
                        </div>
                    </div>
                    <div class="form-group" data-condition="event_deposit_enable:is(1)">
                        ...
                        <div class="form-controls">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <input type="number" name="event_deposit_amount" class="form-control" step="0.1"
                                               value="{{old('event_deposit_amount',setting_item('event_deposit_amount',0))}}">
                                        <select name="event_deposit_type" class="form-control">
                                            <option value="fixed">{{__("Fixed")}}</option>
                                            <option @if(old('event_deposit_type',setting_item('event_deposit_type')) == 'percent') selected
                                                    @endif value="percent">{{__("Percent")}}</option>
                                        </select>
                                    </div>
                                </div>
        ...
        <div class="col-sm-8">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox" name="event_disable" value="1"
                                          @if(setting_item('event_disable')) checked @endif > {{__('Yes, please disable it')}}
                            </label>
                        </div>
                    </div>
                </div>
