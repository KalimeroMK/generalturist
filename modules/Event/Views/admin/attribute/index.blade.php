        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{url('admin/module/event/attribute/editAttrBulk')}}"
                    ...
                    <div class="col-left">
                        <form method="get" action="{{url('/admin/module/event/attribute')}} "
                                ...
                                @if(count($rows) > 0)
                                    @foreach($rows as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('event.admin.attribute.edit',['id'=>$row->id])}}"
                                                   class="btn btn-primary btn-sm"><i
                                                            class="fa fa-edit"></i> {{__('Edit')}}
                                                </a>
                                                <a href="{{route('event.admin.attribute.term.index',['id'=>$row->id])}}"
