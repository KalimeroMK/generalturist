@php use Modules\Location\Models\Location; @endphp
...
<div class="mb-3">
    ...
    @php
        $location = !empty(Request()->location_id) ? Location::find(Request()->location_id) : false;
        AdminForm::select2('location_id', [
            'configs' => [
                'ajax'        => [
