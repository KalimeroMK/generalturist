...
@php use Modules\Core\Hook; @endphp
<div class="row">
    <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <input type="text" class="form-control" name="date_format"
                                   value="{{setting_item('date_format','m/d/Y') }}">
                        </div>
                    </div>
                @endif
                @if(is_default_lang())
                            ...
                            <select name="site_timezone" class="form-control">
                                ...
                                @if(!empty($timezones = generate_timezone_list()))
                                    @foreach($timezones as $item=>$value)
                                        <option @if($item == setting_item('site_timezone') ) selected
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="site_first_day_of_the_weekin_calendar" class="form-control">
                                <option @if("1" == (setting_item('site_first_day_of_the_weekin_calendar')) ) selected
                                        @endif value="1">{{__("Monday")}}</option>
                                <option @if("0" == (setting_item('site_first_day_of_the_weekin_calendar')) ) selected
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                                <?php
                                $template = setting_item('home_page_id') ? Page::find(setting_item('home_page_id')) : false;
                    ...
                    @php do_action(Hook::CORE_SETTING_AFTER_HOMEPAGE) @endphp
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls form-group-image">
                            {!! FileHelper::fieldUpload('logo_id',setting_item('logo_id')) !!}
                        </div>
                    </div>
                @endif
                @php do_action(Hook::CORE_SETTING_AFTER_LOGO) @endphp
                @if(is_default_lang())
                    <div class="form-group">
                        <label class="">{{__("Favicon")}}</label>
                        <div class="form-controls form-group-image">
                            {!! FileHelper::fieldUpload('site_favicon',setting_item('site_favicon')) !!}
                        </div>
                    </div>
                @endif
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <div class="form-group-item">
                            <div class="form-group-item">
                                ...
                                <div class="g-items">
                                    <?php
                                    $social_share = setting_item_with_lang('list_widget_footer',
                                        request()->query('lang'));
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <select class="form-control"
                                                        ...
                                                        <option @if(!empty($item['size']) && $item['size']=='3') selected
                                                                @endif value="3">1/4
                                                        </option>
                                                        <option @if(!empty($item['size']) && $item['size']=='4') selected
                                                                @endif value="4">1/3
                                                        </option>
                                                        <option @if(!empty($item['size']) && $item['size']=='6') selected
                                                                @endif value="6">1/2
                                                        </option>
                                                    </select>
                                                </div>
                ...
                @php do_action(Hook::CORE_SETTING_AFTER_FOOTER) @endphp
            </div>
        </div>
    </div>
</div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <textarea name="page_contact_desc" class="d-none has-ckeditor" cols="30"
                                  rows="7">{{setting_item_with_lang('page_contact_desc',request()->query('lang')) }}</textarea>
                    </div>
                </div>
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls form-group-image">
                            {!! FileHelper::fieldUpload('page_contact_image',setting_item('page_contact_image')) !!}
                        </div>
                    </div>
                @endif
                @php do_action(Hook::CORE_SETTING_AFTER_CONTACT) @endphp
            </div>
        </div>
    </div>
</div>
