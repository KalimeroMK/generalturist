            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="form-group" data-condition="map_provider:is(gmap)">
                        ...
                        <div class="form-controls">
                            <input type="text" name="map_gmap_key" value="{{setting_item('map_gmap_key')}}"
                                   class="form-control">
                            <p><i><a href="https://developers.google.com/maps/documentation/javascript/get-api-key"
                                     target="blank">{{__("Learn how to get an api key")}}</a></i></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-controls">
                                <input type="text" name="map_lat_default" value="{{setting_item('map_lat_default')}}"
                                       class="form-control" placeholder="21.030513">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label>{{__("Map Lng Default")}}</label>
                            <div class="form-controls">
                                <input type="text" name="map_lng_default" value="{{setting_item('map_lng_default')}}"
                                       class="form-control" placeholder="105.840565">
                            </div>
                        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label> <input type="checkbox" @if(setting_item('facebook_enable') == 1) checked
                                       @endif name="facebook_enable" value="1"> {{__("Enable Facebook Login?")}}</label>
                    </div>
                    <div class="form-group" data-condition="facebook_enable:is(1)">
                        <label>{{__("Facebook Client Id")}}</label>
                        <div class="form-controls">
                            <input type="text" name="facebook_client_id" value="{{setting_item('facebook_client_id')}}"
                                   class="form-control">
                        </div>
                    </div>
                    <div class="form-group" data-condition="facebook_enable:is(1)">
                        ...
                        <div class="form-controls">
                            <input type="text" name="facebook_client_secret"
                                   value="{{setting_item('facebook_client_id')}}" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label><input type="checkbox" @if(setting_item('google_enable') == 1) checked
                                      @endif name="google_enable" value="1"> {{__("Enable Google Login?")}}</label>
                    </div>
                    <div class="form-group" data-condition="google_enable:is(1)">
                        <label>{{__("Google Client Id")}}</label>
                        <div class="form-controls">
                            <input type="text" name="google_client_id" value="{{setting_item('google_client_id')}}"
                                   class="form-control">
                        </div>
                    </div>
                    <div class="form-group" data-condition="google_enable:is(1)">
                        ...
                        <div class="form-controls">
                            <input type="text" name="google_client_secret"
                                   value="{{setting_item('google_client_secret')}}" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label> <input type="checkbox" @if(setting_item('twitter_enable') == 1) checked
                                       @endif name="twitter_enable" value="1"> {{__("Enable Twitter Login?")}}</label>
                    </div>
                    <div class="form-group" data-condition="twitter_enable:is(1)">
                        <label>{{__("Twitter Client Id")}}</label>
                        <div class="form-controls">
                            <input type="text" name="twitter_client_id" value="{{setting_item('twitter_client_id')}}"
                                   class="form-control">
                        </div>
                    </div>
                    <div class="form-group" data-condition="twitter_enable:is(1)">
                        ...
                        <div class="form-controls">
                            <input type="text" name="twitter_client_secret"
                                   value="{{setting_item('twitter_client_secret')}}" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-8">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox" @if(setting_item('recaptcha_enable') == 1) checked
                                          @endif name="recaptcha_enable" value="1"> {{__("Enable ReCaptcha")}}</label>
                        </div>
                    </div>
                    <div class="form-group" data-condition="recaptcha_enable:is(1)">
                        ...
                        <div class="form-controls">
                            <select name="recaptcha_version" id="recaptcha_version" class="form-control">
                                ...
                                <option @if(setting_item('recaptcha_version') =='v3' ) selected
                                        @endif value="v3">{{ __("Version 3") }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group" data-condition="recaptcha_enable:is(1)">
                        ...
                        <div class="form-controls">
                            <input type="text" name="recaptcha_api_key" value="{{setting_item('recaptcha_api_key')}}"
                                   class="form-control">
                            <p><i><a href="http://www.google.com/recaptcha/admin"
                                     target="blank">{{__("Learn how to get an api key")}}</a></i></p>
                        </div>
                    </div>
                    <div class="form-group" data-condition="recaptcha_enable:is(1)">
                        ...
                        <div class="form-controls">
                            <input type="text" name="recaptcha_api_secret"
                                   value="{{setting_item('recaptcha_api_secret')}}" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <textarea name="head_scripts" cols="30" rows="10"
                                      class="form-control">{{setting_item('head_scripts')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <textarea name="body_scripts" cols="30" rows="10"
                                      class="form-control">{{setting_item('body_scripts')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <textarea name="footer_scripts" cols="30" rows="10"
                                      class="form-control">{{setting_item('footer_scripts')}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <textarea name="head_scripts" cols="30" rows="10"
                                      class="form-control">{{setting_item_with_lang_raw('head_scripts',request()->get('lang'))}}</textarea>
                            <p><i>{{__('scripts before closing head tag')}}</i></p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <textarea name="body_scripts" cols="30" rows="10"
                                      class="form-control">{{setting_item_with_lang_raw('body_scripts',request()->get('lang'))}}</textarea>
                            <p><i>{{__('scripts after open of body tag')}}</i></p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <textarea name="footer_scripts" cols="30" rows="10"
                                      class="form-control">{{setting_item_with_lang_raw('footer_scripts',request()->get('lang'))}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox"
                                          @if(setting_item('cookie_agreement_enable') ?? '' == 1) checked
                                          @endif name="cookie_agreement_enable"
                                          value="1"> {{__("Enable Cookie agreement")}}</label>
                        </div>
                    </div>
                @else
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox"
                                          @if(setting_item('cookie_agreement_enable') ?? '' == 1) checked
                                          @endif name="cookie_agreement_enable" disabled
                                          value="1"> {{__("Enable Cookie agreement")}}</label>
                        </div>
                    </div>
