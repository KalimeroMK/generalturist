<?php
    ...
    class BookingController extends Controller
    {
        ...
        /**
         * @param $code
         * @return bool|Application|Factory|View|JsonResponse|RedirectResponse|Redirector|object
         */
         ...
         * @return bool|JsonResponse|object|void
         * @throws Throwable
         */
         ...
         *
         */
        public function addToCart(Request $request): string
        {
            if (!is_enable_guest_checkout() and !Auth::check()) {
                return $this->sendError(__("You have to login in to do this"))->setStatusCode(401);
            }
         ...
         * @param  Request  $request
         * @param $code
         * @return Application|Factory|View|JsonResponse|RedirectResponse|Redirector|object
         */
         ...
         */
        public function exportIcal($id, string $service_type = 'tour')
        {
            Debugbar::disable();
            $allServices = get_bookable_services();
         ...
         * @return JsonResponse
         */
        public function addEnquiry(Request $request): JsonResponse
        {
            $rules = [
                'service_id'    => 'required|integer',
                'service_type'  => 'required',
         ...
         * @return JsonResponse
         */
        public function setPaidAmount(Request $request): JsonResponse
        {
            $rules = [
