<?php
    ...
    class RouterServiceProvider extends ServiceProvider
    {
         ...
         * @var string
         */
        protected string $moduleNamespace = 'Modules\Booking\Controllers';
        protected string $moduleApiNamespace = 'Modules\Booking\Api';

        protected string $adminModuleNamespace = 'Modules\Booking\Admin';
