...
@php use Modules\Booking\Hook; @endphp
@if(is_default_lang())
    <div class="row">
        <div class="col-sm-4">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="booking_guest_checkout" value="1"
                                          @if(!empty($settings['booking_guest_checkout'])) checked @endif /> {{__("Yes, please")}}
                            </label>
                            <br>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="booking_enable_ticket_guest_info" value="1"
                                          @if(!empty($settings['booking_enable_ticket_guest_info'])) checked @endif /> {{__("Yes, please")}}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="booking_enable_recaptcha" value="1"
                                          @if(!empty($settings['booking_enable_recaptcha'])) checked @endif /> {{__("On ReCapcha")}}
                            </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                                <?php
                                $template = !empty($settings['booking_term_conditions']) ? Page::find($settings['booking_term_conditions']) : false;
                ...
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls form-group-image">
                            {!! FileHelper::fieldUpload('logo_invoice_id',$settings['logo_invoice_id'] ?? '') !!}
                        </div>
                    </div>
                @endif
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <textarea name="invoice_company_info" class="d-none has-ckeditor" cols="30"
                                  rows="10">{{setting_item_with_lang('invoice_company_info',request()->query('lang')) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
...
<hr>
@php do_action(Hook::BOOKING_SETTING_AFTER_INVOICE) @endphp
