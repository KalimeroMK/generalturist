...
Route::group(['prefix' => config('booking.booking_route_prefix')], function () {
    ...
    Route::post('/setPaidAmount', 'BookingController@setPaidAmount')->name('booking.setPaidAmount')->middleware([
        'auth', 'dashboard'
    ]);
...
Route::group(['prefix' => 'gateway'], function () {
    ...
    Route::match(['get', 'post'], '/gateway_callback/{gateway}',
        'BookingController@callbackPayment')->name('gateway.webhook');
});
