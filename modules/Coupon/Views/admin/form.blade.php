        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" maxlength="50" required value="{{$row->code}}"
                           placeholder="{{__("Unique Code")}}" name="code" class="form-control">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" name="discount_type">
                        <option @if($row->discount_type && $row->discount_type == 'fixed') selected
                                @endif value="fixed">{{__("Amount")}}</option>
                        <option @if($row->discount_type && $row->discount_type == 'percent') selected
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$row->end_date}}" placeholder="{{__("2021-12-12 00:00:00")}}"
                           name="end_date" class="form-control has-datetimepicker">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$row->min_total}}" placeholder="{{__("No Minimum")}}" name="min_total"
                           class="form-control">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$row->max_total}}" placeholder="{{__("No Maximum")}}" name="max_total"
                           class="form-control">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php
                    AdminForm::select2('only_for_user[]', [
                        'configs' => [
                            'ajax' => [
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" value="{{$row->quantity_limit}}" placeholder="{{__("Unlimited Usage")}}"
                           name="quantity_limit" class="form-control">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label>{{__("Usage Limit Per User")}}</label>
                    <input type="number" value="{{$row->limit_per_user}}" placeholder="{{__("Unlimited Usage")}}"
                           name="limit_per_user" class="form-control">
                </div>
            </div>
        </div>
    </div>
