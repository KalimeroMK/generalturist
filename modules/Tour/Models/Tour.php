...
//            ORDER BY (POW((lon-$lon),2) + POW((lat-$lat),2))";
        ...
        public function getNumberAvailableBooking($start_date)
        {
            ...
            $totalGuests = $this->bookingClass::where('object_id', $this->id)->where('start_date', $start_date)->whereNotIn('status',
                $this->bookingClass::$notAcceptedStatus)->sum('total_guests');
