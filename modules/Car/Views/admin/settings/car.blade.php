            ...
            <div class="panel-body">
                ...
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <input type="number" min="1" name="car_page_limit_item" placeholder="{{ __("Default: 9") }}"
                    ...
                    <div class="form-group" data-condition="car_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <div class="form-group-item">
                                ...
                                <div class="g-items">
                                    <?php
                                    use Modules\Language\Models\Language;if(!empty($settings['car_review_stats'])){
                    ...
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            ...
                            @if(!empty($settings['car_booking_buyer_fees']))
                                <?php $car_booking_buyer_fees = json_decode($settings['car_booking_buyer_fees'],
                                    true); ?>
