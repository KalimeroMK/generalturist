                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="number" class="form-control"
                                   value="{{$row->number}}" placeholder="{{__("Car Number")}}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="price" class="form-control"
                                   value="{{$row->price}}" placeholder="{{__("Car Price")}}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" name="sale_price" class="form-control"
                                   value="{{$row->sale_price}}" placeholder="{{__("Car Sale Price")}}">
...
@endif
<?php
do_action(Hook::FORM_AFTER_SERVICE_FEE, $row) ?>