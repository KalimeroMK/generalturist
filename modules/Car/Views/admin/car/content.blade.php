<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="{!! clean($translation->title) !!}" placeholder="{{__("Name of the car")}}"
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{$row->passenger}}" placeholder="{{__("Example: 3")}}"
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$row->gear}}" placeholder="{{__("Example: Auto")}}" name="gear"
                               class="form-control">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{$row->baggage}}" placeholder="{{__("Example: 5")}}" name="baggage"
                               class="form-control">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>{{__("Door")}}</label>
                        <input type="number" value="{{$row->door}}" placeholder="{{__("Example: 4")}}" name="door"
                               class="form-control">
                    </div>
                </div>
            </div>
