...
@section('content')
    <div class="container-fluid">
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                @if(!empty($rows))
                    <form method="post" action="{{route('space.admin.bulkEdit')}}"
            ...
            <div class="col-left dropdown">
                <form method="get"
                      action="{{ !empty($recovery) ? route('space.admin.recovery') : route('space.admin.index')}}"
                            ...
                            @if($rows->total() > 0)
                                @foreach($rows as $row)
                                    <tr class="{{$row->status}}">
                                        ...
                                        <td>
                                            @if(empty($recovery))
                                                <a href="{{route('space.admin.edit',['id'=>$row->id])}}"
