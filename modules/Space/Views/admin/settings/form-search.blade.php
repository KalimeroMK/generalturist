                    ...
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            @php
                                ...
                                $attrs = Attributes::where('service', 'space')->get();
                            @endphp
                                ...
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                        <div class="col-md-7">
                                            @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                @foreach($languages as $language)
                                                    ...
                                                    <div class="g-lang">
                                                        ...
                                                        <input type="text"
                                                               name="space_search_fields[{{$key}}][title{{$key_lang}}]"
                                                               value="{{$item['title'.$key_lang] ?? ''}}"
                                                               class="form-control">
                                                    </div>
                                                @endforeach
                                            @else
                                                <input type="text" name="space_search_fields[{{$key}}][title]"
                                            ...
                                            <br>
                                            <select name="space_search_fields[{{$key}}][attr]"
                                            ...
                                            <br>
                                            <select name="space_search_fields[{{$key}}][size]"
                                                    class="mt-2 custom-select">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="space_search_fields[{{$key}}][position]" min="0"
                            ...
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    <div class="col-md-7">
                                        @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                            @foreach($languages as $language)
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang">{{$language->name}}</div>
                                                    <input type="text"
                                                           __name__="space_search_fields[__number__][title{{$key_lang}}]"
                                                           class="form-control">
                                                </div>
                                            @endforeach
                                        @else
                                            <input type="text" __name__="space_search_fields[__number__][title]"
                                                   class="form-control">
                                        @endif
                                        ...
                                        <br>
                                        <select __name__="space_search_fields[__number__][attr]"
                                                class="mt-2 custom-select">
                                            <option value="">{{__("-- Select Attribute --")}}</option>
                                            @foreach($attrs as $attr)
                                        ...
                                        <br>
                                        <select __name__="space_search_fields[__number__][size]"
                                                class="mt-2 custom-select">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" __name__="space_search_fields[__number__][position]"
