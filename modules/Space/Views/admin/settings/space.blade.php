@php use Modules\Space\Hook; @endphp
                ...
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls form-group-image">
                            {!! FileHelper::fieldUpload('space_page_search_banner',$settings['space_page_search_banner'] ?? "") !!}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" data-condition="space_location_search_style:is(autocompletePlace)">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="space_location_radius_value" min="0"
                                       value="{{ setting_item('space_location_radius_value',1)}}" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-controls">
                                <input type="text" name="space_map_lat_default"
                                       value="{{$settings['space_map_lat_default'] ?? ''}}" class="form-control"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-controls">
                                <input type="text" name="space_map_lng_default"
                                       value="{{$settings['space_map_lng_default'] ?? ''}}" class="form-control"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-controls">
                                <input type="text" name="space_map_zoom_default"
                                       value="{{$settings['space_map_zoom_default'] ?? ''}}" class="form-control"
                                       placeholder="13">
                            </div>
                        </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <div class="form-controls form-group-image">
                            {!! FileHelper::fieldUpload('space_icon_marker_map',$settings['space_icon_marker_map'] ?? "") !!}
                        </div>
                    </div>
                    @php do_action(Hook::SPACE_SETTING_AFTER_MAP) @endphp
                @endif
            </div>
        </div>
                        ...
                        <div class="tab-pane active" id="seo_1">
                            ...
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                                    ...
                                    {!! FileHelper::fieldUpload('space_page_list_seo_image', $settings['space_page_list_seo_image'] ?? "" ) !!}
                                </div>
                            @endif
                        </div>
                        @php
                        ...
                        <div class="tab-pane" id="seo_2">
                            ...
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                                    ...
                                    {!! FileHelper::fieldUpload('space_page_list_seo_share[facebook][image]',$seo_share['facebook']['image'] ?? "" ) !!}
                                </div>
                            @endif
                        </div>
                        <div class="tab-pane" id="seo_3">
                            ...
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                                    ...
                                    {!! FileHelper::fieldUpload('space_page_list_seo_share[twitter][image]', $seo_share['twitter']['image'] ?? "" ) !!}
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            ...
                            @if(!empty($settings['space_booking_buyer_fees']))
                                    <?php
                                    $space_booking_buyer_fees = json_decode($settings['space_booking_buyer_fees'],
                                        true); ?>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_allow_vendor_can_add_service_fee" value="1"
                                          @if(!empty($settings['space_allow_vendor_can_add_service_fee'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="space_deposit_type" class="form-control">
                                            <option value="fixed">{{__("Fixed")}}</option>
                                            <option @if(old('space_deposit_type',setting_item('space_deposit_type')) == 'percent') selected
                                                    @endif value="percent">{{__("Percent")}}</option>
                                        </select>
                                    </div>
                                </div>
