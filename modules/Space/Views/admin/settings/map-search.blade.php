                    ...
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            ...
                            @foreach($space_map_search_fields as $key=>$item)
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <select name="space_map_search_fields[{{$key}}][field]"
                                                    class="custom-select">
                                            ...
                                            <br>
                                            <select name="space_map_search_fields[{{$key}}][attr]"
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="space_map_search_fields[{{$key}}][position]"
                        ...
                        <div class="g-more hide">
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    <div class="col-md-7">
                                        <select __name__="space_map_search_fields[__number__][field]"
                                                class="custom-select">
                                            <option value="">{{__("-- Select field type --")}}</option>
                                            @foreach($types as $type=>$name)
                                        ...
                                        <select __name__="space_map_search_fields[__number__][attr]"
                                                class=" mt-2  custom-select">
                                            <option value="">{{__("-- Select Attribute --")}}</option>
                                            @foreach($attrs as $attr)
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" __name__="space_map_search_fields[__number__][position]"
