        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{route('space.admin.attribute.term.editTermBulk')}}"
                    ...
                    <div class="col-left">
                        <form method="get" action="{{route('space.admin.attribute.term.index',['id'=>$attr->id])}} "
                                    ...
                                    @foreach ($rows as $row)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary btn-sm"
                                                   href="{{route('space.admin.attribute.term.edit',['id'=>$row->id])}}"><i
