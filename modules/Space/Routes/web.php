...
Route::group(['prefix' => 'user/'.config('space.space_route_prefix'), 'middleware' => ['auth', 'verified']],
    function () {
        ...
        Route::get('/booking-report/bulkEdit/{id}',
            'ManageSpaceController@bookingReportBulkEdit')->name("space.vendor.booking_report.bulk_edit");
