            ...
            <div class="post-author">
                <div class="media mb-2">
                    ...
                    <div class="media-body">
                        <textarea name="content" placeholder="{{__("How are you feeling today?")}}"
                                  class="form-control mb-1" cols="30" rows="2"></textarea>
                        <div class="list-files-uploaded mb-1">

                        </div>
                        <ul class="list-unstyled post-add-files">
                            <li><a href="#" class="btn text-center btn-light btn-sm"><i
                                            class="svg-icon picture-icon"></i></a></li>
                        </ul>
                    </div>
                </div>
