...
@section('content')
    <div class="container">
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                @if(!empty($rows))
                    <form method="post" action="{{route('page.admin.bulkEdit')}}"
            ...
            <div class="col-left">
                <form method="get" action="{{route('page.admin.index')}} "
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a href="{{route('page.admin.builder',['id'=>$row->id])}}"
                                                   class="dropdown-item"><i
                                                            class="fa fa-paint-brush"></i> {{__('Template Builder')}}
                                                </a>
                                                <div class="dropdown-divider"></div>
                                                <a href="{{route('page.detail',['slug'=>$row->slug])}}"
                                                   class="dropdown-item"><i class="fa fa-eye"></i> {{__('View')}}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
