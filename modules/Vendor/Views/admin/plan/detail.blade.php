        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    @if($row->slug)
                        <p class="item-url-demo">{{ __('Permalink: ')}} {{ url( config('page.page_route_prefix') )}}/<a
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label>{{ __('Name')}}</label>
                                <input type="text" value="{{$row->name}}" placeholder="Name" name="name"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                                <label>{{ __('Base Commission (%)')}}</label>
                                <input type="number" value="{{$row->base_commission}}" min="1" max="100"
                                       placeholder="Base Commission" name="base_commission" class="form-control">
                            </div>
                        </div>
                    </div>
