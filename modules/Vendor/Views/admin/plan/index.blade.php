...
@section('content')
    <div class="container-fluid">
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                @if(!empty($rows))
                    <form method="post" action="{{url('admin/module/vendor/plan/bulkEdit')}}"
            ...
            <div class="col-left">
                <form method="get" action="{{url('/admin/module/vendor/plan/')}} "
                      class="filter-form filter-form-right d-flex justify-content-end" role="search">
                    <input type="text" name="page" value="{{ Request()->page }}" placeholder="{{__('Search by name')}}"
                           class="form-control">
