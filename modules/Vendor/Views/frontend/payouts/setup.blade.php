@php
    use Illuminate\Support\Arr;$vendor_payout_methods = json_decode(setting_item('vendor_payout_methods'));
    if(!is_array($vendor_payout_methods)) return;

    $vendor_payout_methods = array_values(Arr::sort($vendor_payout_methods, function ($value) {
                ...
                <table class="table table-bordered">
                    ...
                    @foreach($vendor_payout_methods as $k=>$method)
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="payout_accounts[{{$method->id}}]" class="form-control" cols="30"
                                          rows="3"
