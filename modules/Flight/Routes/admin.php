...
Route::group(['prefix' => 'airport'], function () {
    ...
    Route::get('/import-iata',
        'AirportController@importIATA')->name('flight.admin.airport.importIATA')->middleware('signed');
});
...
Route::group(['prefix' => 'attribute'], function () {
    ...
    Route::match(['get', 'post'], 'term_store',
        'AttributeController@term_store')->name('flight.admin.attribute.term.store');
