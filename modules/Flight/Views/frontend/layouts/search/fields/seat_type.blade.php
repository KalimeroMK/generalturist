                ...
                <div class="render font-size-14">
                    @foreach($seatType as $type)
                        ...
                        <span class="" id="{{$inputRender}}">
                            ...
                            <span class="@if($inputValue <= $minValue) d-none @endif multi"
            ...
            @foreach($seatType as $type)
                ...
                <div class="dropdown-item-row">
                    ...
                    <div class="val">
                        ...
                        <span class="count-display"><input id="{{$inputName}}" type="number"
                                                           name="seat_type[{{$type->code}}]" value="{{$inputValue}}"
                                                           min="{{$minValue}}"></span>
                        <span class="btn-add" data-input="{{$inputName}}" data-input-attr="id"><i
