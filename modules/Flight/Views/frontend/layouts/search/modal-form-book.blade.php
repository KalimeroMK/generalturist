                        ...
                        <div class="row text-center">
                            <div class="col-md-4">
                                <div class="d-block d-lg-flex flex-horizontal-center">
                                    <img class="img-fluid mr-3 mb-3 mb-lg-0" :src="flight.airline.image_url??''"
                                ...
                                <ul class="d-block d-md-flex justify-content-between list-group list-group-borderless list-group-horizontal list-group-flush no-gutters border-bottom "
                                    ...
                                    <li class="mr-md-8 mr-lg-8 mb-3 mt-3 d-flex d-md-block justify-content-between list-group-item py-0 border-0">
                                        ...
                                        <div class="flex-horizontal-center">
                                            ...
                                            <input class="form-control h-auto width-30  d-inline-block font-weight-bold  shadow-none border-0 rounded p-0 mx-1 text-center"
                                                   type="text" @change="updateNumberFlightSeat(flight_seat)"
