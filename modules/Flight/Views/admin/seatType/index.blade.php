        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{route('flight.admin.seat_type.bulkEdit')}}"
                    ...
                    <div class="col-left">
                        <form method="get" action="{{route('flight.admin.seat_type.index')}} "
                                    ...
                                    @foreach ($rows as $row)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary btn-sm"
                                                   href="{{route('flight.admin.seat_type.edit',['id'=>$row->id])}}"><i
