...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            ...
            <a href="{{URL::signedRoute('flight.admin.airport.importIATA')}}" class="btn btn-primary"
               onclick="return confirm('Do you want to import all list airports from IATA?')">{{__('Import from IATA')}}</a>
        </div>
