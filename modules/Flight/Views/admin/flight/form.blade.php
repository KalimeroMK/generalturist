    ...
    <div class="panel-body">
        <div class="row">
            <div class="form-group col-lg-6">
                <label>{{__("Name")}}</label>
                <input type="text" value="{{old("title",$row->title)}}" placeholder="{{__("Name")}}" name="title"
                       class="form-control">
            </div>
            <div class="form-group col-lg-6">
                <label>{{__("Code")}}</label>
                <input type="text" value="{{old("code",$row->code)}}" placeholder="{{__("Code")}}" name="code"
                       class="form-control">
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="departure_time" class="form-control has-datetimepicker"
                           value="{{old("departure_time",$row->departure_time)}}"
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="arrival_time" class="form-control has-datetimepicker"
                           value="{{old("arrival_time",$row->arrival_time)}}" placeholder="{{__("Arrival time")}}">
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="duration" class="form-control"
                               value="{{old("duration",$row->duration)}}" placeholder="{{__("Duration")}}"
