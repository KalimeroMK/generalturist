                    ...
                    <div class="form-group-item">
                                ...
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                        <div class="col-md-7">
                                            @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                @foreach($languages as $language)
                                                    ...
                                                    <div class="g-lang">
                                                        ...
                                                        <input type="text"
                                                               name="flight_search_fields[{{$key}}][title{{$key_lang}}]"
                                                               value="{{$item['title'.$key_lang] ?? ''}}"
                                                               class="form-control">
                                                    </div>
                                                @endforeach
                                            @else
                                                <input type="text" name="flight_search_fields[{{$key}}][title]"
                                            ...
                                            <br>
                                            <select name="flight_search_fields[{{$key}}][size]"
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="flight_search_fields[{{$key}}][position]" min="0"
                        ...
                        <div class="g-more hide">
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    <div class="col-md-7">
                                        <input type="text" __name__="flight_search_fields[__number__][title]" value=""
                                               class="form-control">
                                        <select __name__="flight_search_fields[__number__][field]"
                                                class="custom-select">
                                            <option value="">{{__("-- Select field type --")}}</option>
                                            @foreach($types as $type=>$name)
                                        ...
                                        <br>
                                        <select __name__="flight_search_fields[__number__][size]"
                                                class="mt-2 custom-select">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" __name__="flight_search_fields[__number__][position]"
