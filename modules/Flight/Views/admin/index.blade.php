...
@section('content')
    <div class="container-fluid">
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                @if(!empty($rows))
                    <form method="post" action="{{route('flight.admin.bulkEdit')}}"
            ...
            <div class="col-left dropdown">
                <form method="get"
                      action="{{ !empty($recovery) ? route('flight.admin.recovery') : route('flight.admin.index')}}"
                    ...
                    @if(!empty($rows) and $flight_manage_others)
                        ...
                        <div class="ml-3 position-relative">
                            <button class="btn btn-secondary dropdown-toggle bc-dropdown-toggle-filter" type="button"
                                    id="dropdown_filters">
                                {{ __("Advanced") }}
                            </button>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                <button class="btn btn-primary dropdown-toggle" type="button"
                                                        ...
                                                        aria-haspopup="true" aria-expanded="false"><i class="fa fa-th"
                                                                                                      aria-hidden="true"></i>
                                                </button>
                                                <div class="dropdown-menu dropdown-menu-right"
                                                     aria-labelledby="dropdownMenuButton">
                                                    <a href="{{route('flight.admin.edit',['id'=>$row->id])}}"
                                                       class="dropdown-item btn btn-primary "><i
                                                                class="fa fa-edit"></i> {{__('Edit')}}</a>
                                                    <a href="{{route('flight.admin.flight.seat.index',['flight_id'=>$row->id])}}"
                                                       class="dropdown-item btn btn-primary "><i
                                                                class="fa fa-ticket"></i> {{__('Flight ticket')}}</a>
