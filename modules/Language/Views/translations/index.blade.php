...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-between mb20">
            ...
            <a class="btn btn-primary" href="{{route('language.admin.translations,loadStrings')}}"><i
                                    ...
                                    @foreach($languages as $language)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('language.admin.translations.build',['id'=>$language->id])}}"
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                       href="{{route('language.admin.translations.loadTranslateJson',['locale'=>$language->locale])}}">{{__
