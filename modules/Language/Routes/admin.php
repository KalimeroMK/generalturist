...
Route::group(['prefix' => 'translation'], function () {
    ...
    Route::get('loadTranslateJson',
        'TranslationsController@loadTranslateJson')->name('language.admin.translations.loadTranslateJson');
    Route::get('loadStrings', 'TranslationsController@loadStrings')->name('language.admin.translations,loadStrings');
    Route::get('findTranslations',
        'TranslationsController@findTranslations')->name('language.admin.translations.findTranslations');
});
